...
function About() {
  return (
    <section className="container">
      <h2 class="head top-title">About Me</h2>
      <hr></hr>
      <div>
        ...
        <p>
          ...
          achieving success in the workplace begins with having a strong mind,
          body and spirit which he channels through physical sports, competitive
